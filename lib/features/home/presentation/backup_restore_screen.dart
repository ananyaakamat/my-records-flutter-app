        ...
        content: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text('• Backup files are saved with .enc extension'),
              SizedBox(height: 16),
              Text(
                'Automatic Backup:',
              ...
              SizedBox(height: 4),
              Text(
                  '• Backups saved to Downloads/my_records folder as .enc files'),
              SizedBox(height: 4),
              Text(
              ...
              SizedBox(height: 4),
              Text('• Includes automatic cleanup of orphaned records'),
              SizedBox(height: 16),
              Text(
                'Manual Backup:',
                style: TextStyle(fontWeight: FontWeight.w600),
              ...
              SizedBox(height: 8),
              Text('• Select any .enc backup file from your device'),
              SizedBox(height: 4),
